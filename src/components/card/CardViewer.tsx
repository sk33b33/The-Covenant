      ...
      <div className="flex-1 min-h-0 flex flex-col items-center justify-center px-4 pt-safe pb-6 gap-1 overflow-hidden">
        ...
        <motion.div
          ...
          style={{
            ...
            // edge of the card projects wider than the far edge, so a
            // rectangle reads as keystoned — corners pulled out of true —
            // rather than as itself turning in space. That taper shrinks
            // as the vanishing point moves out, so a further one keeps the
            // card's own proportions intact through the whole tilt: at
            // `MAX_TILT`'s full 18°, the near and far edges differ by
            // roughly 2% of the card's width here, well past where the eye
            // can tell the shape moved at all.
            perspective: '4800px',
